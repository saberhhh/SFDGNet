...
class ReverseFusion(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(ReverseFusion, self).__init__()
        self.upsample = nn.Conv1d(in_channels, out_channels, kernel_size=1, bias=False)
    ...
    def forward(self, low_feat, high_feat):
        ...
        fusion = torch.cat((low_feat, high_feat), dim=1)
        attention = self.attention(fusion)
        out = low_feat + high_feat * attention 
        return out
...
class DGCNN_semseg_s3dis(nn.Module):
    def __init__(self, args):
        ...
        self.conv6 = nn.Sequential(nn.Conv1d(192, args.emb_dims, kernel_size=1, bias=False),
                                   self.bn6,
                                   nn.LeakyReLU(negative_slope=0.2))
        self.reverse_fusion1 = ReverseFusion(64, 64)
        self.reverse_fusion2 = ReverseFusion(64, 64)
